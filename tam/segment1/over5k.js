...
const OUTPUT_FILE = path.join(__dirname, "over5k-results.json");
...
const JOB_TITLES_INCLUDE = [
    ...
    // Director / VP / SVP / Head of Brand Marketing
    ...
    // "Brand Partnerships", "Cultural Marketing", "Cultural Partnerships", "Brand Collaborations", "Creative Marketing", "Experiential Creative"
    "Brand Partnerships",
    "Cultural Marketing",
    ...
    // Director / Head of / SVP / VP of Influencer
...
// Split search sections by location (NYC Metro HQ / Remote Person in NYC) and 5k+ employee ranges ("5001-10000" and "10001+")
const SECTIONS = [
    {
        label: "NYC Metro HQ (5001-10000)",
        filters: {
            company: {
                hq: {
                    city: {
    ...
    {
        label: "Person in NYC (5001-10000)",
        filters: {
            company: {
                employee_range: ["5001-10000"],
                industry: {
...
async function main() {
    ...
    console.log("  Blitz TAM People Search - over5k (5,000+ Employees)");
    ...
    if (fs.existsSync(OUTPUT_FILE)) {
        try {
            ...
            console.warn("  ⚠ Could not parse existing over5k-results.json — starting fresh.");
            existingOutput = [];
        }
    }
